...
<div>
    ...
    <div class="relative mt-2 rounded-md shadow-sm">
        <input @disabled($disabled)
            ...
            {{ $attributes->merge(['class' => 'block w-full rounded-md border-0 px-2 py-1.5 pr-10 text-red-900 ring-1 ring-inset ring-red-300 placeholder:text-red-300 focus:ring-2 focus:ring-inset focus:ring-red-500 sm:text-sm/6']) }}
